      ...
      <div className="bg-slate-900 w-full h-full">
        <div className="bg-gradient-to-b from-violet-600/[.15] via-transparent h-full">
          <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-24 space-y-8 h-full flex flex-col items-center justify-center gap-4">
            ...
            <div className="max-w-3xl text-center mx-auto">
              <p className="text-lg text-gray-400">0xFeather is a new open source, fast, light weight wallet in the Ethereum ecosystem.</p>
              <p className="text-lg text-gray-400">And you would love it!</p>
            </div>
